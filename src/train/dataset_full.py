...
class CnCDataset_Full(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return {"jpg": image, "txt": caption, "bg_depth": bg_depth, "fg_depth": fg_depth, "bg_emb": bg_emb, "fg_emb": fg_emb, "mask": mask}
...
if __name__ == "__main__":
    ...
    config = OmegaConf.load("configs/cnc_v1.yaml")
